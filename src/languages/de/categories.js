export const cateLists = {
  eatingDe: [
    ...
    {category: "Nachtische",link: "/de/desserts", words:["Kuchen","Macaron","Keks","Strudel","Torte","Berliner","Krapfen","Schokolade","Pudding","Mousse","Eiscreme","Gelato","Bingsu","Brownie"]}
  ],
  geographyDe: [
